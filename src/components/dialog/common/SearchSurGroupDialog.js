...
class SearchSurGroupDialog extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedDate: today,
          ...
          <React.Fragment>
            ...
            <div className="searchFranchise-Dialog">
              <div className="searchFranchise-content">
                <div className="searchFranchise-title">할증 그룹 조회</div>
                <img
                  onClick={close}
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchSurGroupDialog);
