...
class ModifyFranDialog extends Component {
  ...
  handleSubmit = () => {
    httpPost(httpUrl.franchiseUpdate, [], {
      ...
      frName: this.formRef.current.getFieldsValue().franchiseName,
      businessNumber: this.formRef.current.getFieldsValue().businessNumber,
      ownerName: this.formRef.current.getFieldsValue().ceoName,
      email: this.formRef.current.getFieldsValue().franEmail,
      phone: this.formRef.current.getFieldsValue().phoneNumber,
      birth: this.formRef.current.getFieldsValue().birth,
      memo: this.formRef.current.getFieldsValue().franMemo,
      addr1: this.formRef.current.getFieldsValue().franAddress,
      addr3: this.formRef.current.getFieldsValue().franAddressSub,
      basicDeliveryPrice: this.formRef.current.getFieldsValue().callAmount,
      password: this.formRef.current.getFieldsValue().changePwd,
      ...
      // frPhone: "02-111-2222",
      frStatus: 3,
      id: "HumanIntegrationDesigner4783",
      idx: 11200,
      ...
      .then((result) => {
        ...
        this.props.close();
        // this.props.history.push('/franchise/FranchiseMain')
      })
      .catch((e) => {
          ...
          <React.Fragment>
            ...
            <div className="modifyFran-Dialog">
              <div className="modifyFran-container">
                <div className="modifyFran-title">가맹점 수정</div>
                <img
                  onClick={close}
                  ...
                  <div className="layout">
                    <div className="modifyFranLayout">
                      <div className="modifyFranWrapper">
                        <div className="modifyFranTitle">기본정보</div>
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="franchiseName" className="selectItem">
                            <Input
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="ceoName" className="selectItem">
                            <Input
                        ...
                        <div className="contentBlock">
                          <div className="mainTitle red">*이메일</div>
                          <FormItem name="franEmail" className="selectItem">
                            <Input
                              placeholder="(필수입력) 세금계산서 발행용"
                              className="override-input"
                            ></Input>
                          </FormItem>
                        </div>
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="phoneNumber" className="selectItem">
                            <Input
                      ...
                      <div className="modifyFranWrapper">
                        <div className="contentBlock">
                          <div className="mainTitle">생년월일</div>
                          <FormItem name="birth" className="selectItem">
                            <Input
                              placeholder="ex) 19960404"
                              className="override-input sub"
                              defaultValue={"1994-09-23"}
                            ></Input>
                          </FormItem>
                        </div>
                        <div className="contentBlock">
                          <div className="mainTitle">메모</div>
                          <FormItem name="franMemo" className="selectItem">
                            <Input
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="franAddress" className="selectItem">
                            <Input
                              placeholder="주소 입력"
                              className="override-input sub"
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="callAmount" className="selectItem">
                            <Input
                              ...
                              defaultValue={data.basicDeliveryPrice}
                            ></Input>
                          </FormItem>
                          * 기본배달요금
                        </div>
                        ...
                        <div className="contentBlock">
                          ...
                          <FormItem name="changePwd" className="selectItem">
                            <Input
                              placeholder="비밀번호 입력"
                              className="override-input sub"
                            ></Input>
